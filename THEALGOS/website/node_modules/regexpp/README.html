...
<body>
<h1 id="regexpp">regexpp</h1>
<p><a href="https://www.npmjs.com/package/regexpp"><img src="https://img.shields.io/npm/v/regexpp.svg" alt="npm version" /></a> <a href="http://www.npmtrends.com/regexpp"><img src="https://img.shields.io/npm/dm/regexpp.svg" alt="Downloads/month" /></a> <a href="https://github.com/mysticatea/regexpp/actions"><img src="https://github.com/mysticatea/regexpp/workflows/CI/badge.svg" alt="Build Status" /></a> <a href="https://codecov.io/gh/mysticatea/regexpp"><img src="https://codecov.io/gh/mysticatea/regexpp/branch/master/graph/badge.svg" alt="codecov" /></a> <a href="https://david-dm.org/mysticatea/regexpp"><img src="https://david-dm.org/mysticatea/regexpp.svg" alt="Dependency Status" /></a></p>
<p>A regular expression parser for ECMAScript.</p>
<h2 id="installation">💿 Installation</h2>
<div class="sourceCode" id="cb1"><pre class="sourceCode bash"><code class="sourceCode bash"><a class="sourceLine" id="cb1-1" title="1">$ <span class="ex">npm</span> install regexpp</a></code></pre></div>
<ul>
...
<a class="sourceLine" id="cb2-2" title="2">    AST<span class="op">,</span></a>
<a class="sourceLine" id="cb2-3" title="3">    RegExpParser<span class="op">,</span></a>
<a class="sourceLine" id="cb2-4" title="4">    RegExpValidator<span class="op">,</span></a>
<a class="sourceLine" id="cb2-5" title="5">    RegExpVisitor<span class="op">,</span></a>
<a class="sourceLine" id="cb2-6" title="6">    parseRegExpLiteral<span class="op">,</span></a>
<a class="sourceLine" id="cb2-7" title="7">    validateRegExpLiteral<span class="op">,</span></a>
<a class="sourceLine" id="cb2-8" title="8">    visitRegExpAST</a>
<a class="sourceLine" id="cb2-9" title="9"><span class="op">}</span> <span class="im">from</span> <span class="st">&quot;regexpp&quot;</span></a></code></pre></div>
...
<h4 id="parser.parseliteralsource-start-end">parser.parseLiteral(source, start?, end?)</h4>
...
<h4 id="parser.parsepatternsource-start-end-uflag">parser.parsePattern(source, start?, end?, uFlag?)</h4>
...
<h4 id="parser.parseflagssource-start-end">parser.parseFlags(source, start?, end?)</h4>
...
<h4 id="validator.validateliteralsource-start-end">validator.validateLiteral(source, start, end)</h4>
...
<h4 id="validator.validatepatternsource-start-end-uflag">validator.validatePattern(source, start, end, uFlag)</h4>
...
<h4 id="validator.validateflagssource-start-end">validator.validateFlags(source, start, end)</h4>
...
<h4 id="visitor.visitast">visitor.visit(ast)</h4>
<p>Validate a regular expression literal.</p>
<ul>
<li><strong>Parameters:</strong>
<ul>
