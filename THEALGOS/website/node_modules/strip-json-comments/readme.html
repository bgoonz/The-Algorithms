...
<body>
<h1 id="strip-json-comments-build-status">strip-json-comments <a href="https://travis-ci.com/github/sindresorhus/strip-json-comments"><img src="https://travis-ci.com/sindresorhus/strip-json-comments.svg?branch=master" alt="Build Status" /></a></h1>
<blockquote>
...
<pre><code>$ npm install strip-json-comments</code></pre>
<h2 id="usage">Usage</h2>
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="kw">const</span> json <span class="op">=</span> <span class="vs">`{</span></a>
<a class="sourceLine" id="cb3-2" title="2"><span class="vs">    // Rainbows</span></a>
<a class="sourceLine" id="cb3-3" title="3"><span class="vs">    &quot;unicorn&quot;: /* ❤ */ &quot;cake&quot;</span></a>
<a class="sourceLine" id="cb3-4" title="4"><span class="vs">}`</span><span class="op">;</span></a>
<a class="sourceLine" id="cb3-5" title="5"></a>
<a class="sourceLine" id="cb3-6" title="6"><span class="va">JSON</span>.<span class="at">parse</span>(<span class="at">stripJsonComments</span>(json))<span class="op">;</span></a>
<a class="sourceLine" id="cb3-7" title="7"><span class="co">//=&gt; {unicorn: &#39;cake&#39;}</span></a></code></pre></div>
<h2 id="api">API</h2>
