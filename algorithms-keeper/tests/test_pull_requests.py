    ...
    (
        (
            ...
            ExpectedData(
                ...
                post_data=[{"labels": [Label.REVIEW]}, {"body": comment}],
                patch_url=[pr_url],
    ...
    (
        ...
        (
            ...
            ExpectedData(
                ...
                post_data=[{"body": comment}, {"labels": [Label.INVALID]}],
                patch_url=[pr_url],
                patch_data=[{"state": "closed"}],
                delete_url=[reviewers_url],
                delete_data=[{"reviewers": ["test1", "test2"]}],
        ...
        (
            Event(
                data={
                    "action": "submitted",
                    "review": {"state": "commented", "author_association": "NONE"},
                    "pull_request": {},
                },
        ...
        (
            Event(
                data={
                    "action": "submitted",
                    "review": {"state": "commented", "author_association": "MEMBER"},
                    "pull_request": {},
                },
                event="pull_request_review",
        ...
        (
            Event(
                data={
                    ...
                    "pull_request": {"labels": [], "issue_url": issue_url},
                },
                event="pull_request_review",
                delivery_id="changes_requested_by_member_no_label",
            ),
            MockGitHubAPI(),
            ExpectedData(post_url=[labels_url], post_data=[{"labels": [Label.CHANGE]}]),
        ),
        ...
        (
            ...
            MockGitHubAPI(
                getiter={files_url: []},
                getitem={pr_url: {"url": pr_url, "labels": [], "mergeable": True}},
            ),
            ExpectedData(getiter_url=[files_url], getitem_url=[pr_url]),
        ),
