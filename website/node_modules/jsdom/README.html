...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb7-1" title="1"><span class="kw">const</span> <span class="op">{</span> window <span class="op">}</span> <span class="op">=</span> <span class="kw">new</span> <span class="at">JSDOM</span>(<span class="vs">``</span><span class="op">,</span> <span class="op">{</span> <span class="dt">runScripts</span><span class="op">:</span> <span class="st">&quot;outside-only&quot;</span> <span class="op">}</span>)<span class="op">;</span></a>
...
<h3 id="interfacing-with-the-node.js-vm-module-using-getinternalvmcontext">Interfacing with the Node.js <code>vm</code> module using <code>getInternalVMContext()</code></h3>
...
<a class="sourceLine" id="cb20-4" title="4"><span class="kw">const</span> script <span class="op">=</span> <span class="kw">new</span> <span class="at">Script</span>(<span class="vs">`</span></a>
...
<a class="sourceLine" id="cb20-12" title="12"><span class="kw">const</span> vmContext <span class="op">=</span> <span class="va">dom</span>.<span class="at">getInternalVMContext</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb20-13" title="13"></a>
<a class="sourceLine" id="cb20-14" title="14"><span class="va">script</span>.<span class="at">runInContext</span>(vmContext)<span class="op">;</span></a>
<a class="sourceLine" id="cb20-15" title="15"><span class="va">script</span>.<span class="at">runInContext</span>(vmContext)<span class="op">;</span></a>
<a class="sourceLine" id="cb20-16" title="16"><span class="va">script</span>.<span class="at">runInContext</span>(vmContext)<span class="op">;</span></a>
<a class="sourceLine" id="cb20-17" title="17"></a>
<a class="sourceLine" id="cb20-18" title="18"><span class="va">console</span>.<span class="at">assert</span>(<span class="va">dom</span>.<span class="va">window</span>.<span class="at">ran</span> <span class="op">===</span> <span class="dv">3</span>)<span class="op">;</span></a></code></pre></div>
...
<h2 id="supporting-jsdom">Supporting jsdom</h2>
