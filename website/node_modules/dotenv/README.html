...
<body>
<p><strong>Announcement 📣</strong> - From the makers that brought you .env, introducing <a href="http://npmjs.org/package/dotenv-me">.env.me</a>. Sync your .env files across machines. <a href="https://me.dotenv.org/">Join the early access list.</a></p>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode bash"><code class="sourceCode bash"><a class="sourceLine" id="cb6-1" title="1">$ <span class="ex">node</span> -r dotenv/config your_script.js dotenv_config_path=/custom/path/to/.env</a></code></pre></div>
...
<div class="sourceCode" id="cb10"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb10-1" title="1"><span class="at">require</span>(<span class="st">&#39;dotenv&#39;</span>).<span class="at">config</span>(<span class="op">{</span> <span class="dt">path</span><span class="op">:</span> <span class="st">&#39;/custom/path/to/.env&#39;</span> <span class="op">}</span>)</a></code></pre></div>
